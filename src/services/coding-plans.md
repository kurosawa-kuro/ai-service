...
> 2026-07-10: モデル・価格の動きを追記（[docs/tasks/active/最新情報.md](../../docs/tasks/active/最新情報.md) 由来の**二次情報・一次ソース未確認**）。
...
- 参考（別製品・未検証）: M365 Copilot Business は 2026-07-01 から $21/席へ値上げ告知（プロモ $18/席は 12月まで）。
...
- 2026-05 に 5時間枠が恒久2倍化・ピーク時スロットル撤廃、週次上限も一時 +50%（**〜2026-07-13 失効**。失効後の実効上限を観察）。
- 2026-06-30（未検証）: **Sonnet 5** 公開、Claude Code のデフォルトモデル化。Opus 級性能・1M コンテキストの主張 → Pro でも回る範囲が拡大。API プロモ価格 $2/$10（〜8/31、以降 $3/$15。新トークナイザーで約 30% トークン増の主張 → 9月に API コスト再計算）。
...
- 2026-07-09（未検証）: **GPT-5.6**（Sol $5/$30・Terra $2.5/$15・Luna $1/$6）一般公開。**ChatGPT Work**（職場エージェント）は Pro / Enterprise / Edu から展開、数日内に Plus 拡大予告 → Plus/Pro の価値評価に影響。GPT-4.5 は 6/26 で ChatGPT 提供終了、o3 は 8/26 終了予定。
