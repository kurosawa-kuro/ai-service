...
| パス | 役割 |
|---|---|
| [`../src/21_サービス/`](../src/21_サービス/) | サービス / 技術ごとの台帳 |
| [`../src/22_用途/`](../src/22_用途/) | 用途別の逆引き |
| [`../src/30_評価/`](../src/30_評価/) | 実タスクの評価ログ |
| [`../src/23_候補/`](../src/23_候補/) | 未検証候補の棚 |
| [`../src/12_使い分けルール.md`](../src/12_使い分けルール.md) | 使い分け判断の正本 |
| [`../src/10_契約/01_現在の契約.md`](../src/10_契約/01_現在の契約.md) | 今の契約 ／ [`../src/20_モデル/プラン比較.md`](../src/20_モデル/プラン比較.md) プラン比較 |
