...
> 契約側の正本は [contracts/](../contracts/README.md)。本ドキュメントは
> [02_AIフロンティア・バーベル戦略.md](../contracts/02_AIフロンティア・バーベル戦略.md) の
...
- 契約側の正本: [contracts/README.md](../contracts/README.md)
- バーベル戦略（API レグの出典）: [02_AIフロンティア・バーベル戦略.md](../contracts/02_AIフロンティア・バーベル戦略.md)
- 現契約: [01_現在の契約.md](../contracts/01_現在の契約.md)
- ハーネス / ルーティングの用途逆引き: [usecases/ハーネスルーティング.md](../usecases/ハーネスルーティング.md)
- コスト実測ログ: [evaluations/](../evaluations/)
